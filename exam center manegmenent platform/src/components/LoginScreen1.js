...
export class LoginScreen1 extends Component  {
...
<div className="row">
    ...
    <div className="col-lg-6 col-md-8 mx-auto">
      ...
      <div className="card rounded shadow shadow-sm">
        ...
        <center> <h3 style = {{backgroundColor : "#2d7da4",color : "white"}} className="mb-0"><b>Aday Takip Sayfası Giriş Formu</b></h3></center> 
